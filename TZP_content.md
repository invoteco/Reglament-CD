...
**Формат ТЗП:** Директория, содержащая файл MS Word (ТЗП.П.XXXX.N (Техническое задание на проектирование (разработку) [Объект разработки]).docx, где ТЗП-литерал, указывающий, что документ является Техническим заданием на проектирование, [ПМ].XXXX-обозначение Проблемы (Мероприятия), для решения (проведения) которой (которого) предназначенно ТЗ, номер Корректировки ТЗП (0,1....)) с приложенными информационными материалами (эскизы, фотографии, видео, расчеты) в любом цифровом формате. 
