...
**Формат ТЗП:** Директория, именованная ТЗП.П.XXXX.YYYY.N (Техническое задание на проектирование (разработку) [Объект разработки]) содержащая файл MS Word (ТЗП.П.XXXX.YYYY.N Техническое задание на проектирование (разработку) [Объект разработки]).docx, где 
ТЗП-литерал, указывающий, что документ является Техническим заданием на проектирование, 
[ПМ].XXXX-обозначение Проблемы (Мероприятия), для решения (проведения) которой (которого) предназначенно ТЗ, 
