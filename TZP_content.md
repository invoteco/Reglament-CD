...
**Формат ТЗП:** Директория, именованная ТЗП.YYYY.N.[П|М].XXXX.K (Техническое задание на проектирование (разработку) [Объект разработки]) содержащая файл MS Word (ТЗП.YYYY.N.[П|М].XXXX.K Техническое задание на проектирование (разработку) [Объект разработки]).docx, где 

ТЗП-литерал, указывающий, что документ является Техническим заданием на проектирование, 

[П|М].XXXX.K-обозначение Проблемы или Мероприятия, для решения (проведения) которой (которого) предназначенно ТЗП (с номером корректировки K), 
