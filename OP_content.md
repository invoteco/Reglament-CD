# Описание проблемы/мероприятия (ОП, ОМ). Требования к содержанию и оформлению.
...
>Формат поля: Инициатор [Должность Инициатора]  ________________ [ФИО Инициатора].
>В случае, если Мероприятие выполняется в соответствии с утвержденным Планом мероприятий, поле для подписи Инициатором необходимо оставить пустым.
