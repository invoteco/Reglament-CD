...
1.4.   Обозначение Проблемы. Формат П.YYYY, где П-литерал, указывающий, что речь идет о Проблеме, YYYY-порядковый номер Проблемы. 
...
2.4.   Обозначение Мероприятия. Формат М.YYYY, где М-литерал, указывающий, что речь идет о Мероприятии, YYYY-порядковый номер Мероприятия. 
...
3.4.    Обозначение Корректировки. Формат К.YYYY, где К-литерал, указывающий, что речь идет о Корректировке ТД, YYYY-порядковый номер Корректировки. 
